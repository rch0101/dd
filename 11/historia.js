class FlipBook{
    ...
    setPagePosition(page,position,index){
        ...
        page.style.zIndex = position < 0 ? (10 + index) : (10 - index);
        if(page.style.transform != transform){
            page.style.transform = transform;
        }
    }
    turnPage(deltas){
        this.currentPagePosition += deltas;
        ...
        if(this.currentPagePosition == 0){
            ...
            if(this.currentPagePosition == this.elems.leaves.length){
                ...
                this.elems.buttons.next.removeAttribute("disabled","disabled");
                this.elems.buttons.prev.removeAttribute("disabled","disabled");
            }
        }
    }
        setupEvents(){
